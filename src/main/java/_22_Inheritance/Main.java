...
public class Main {
    public static void main(String[] args) {
        ...
        // 상속 - 기존 클래스(부모 클래스)의 속성과 기능(메소드)를 새로운 클랙스(자식 클래스)가 물려받는 것
        // 왜 상속 해야하나?
        // => 코드의 재사용성과 계층 구조 설계를 가능하게 해주는 핵심 개념
        // => 유지 보수 즉 공통 기능이 한 곳(부모 클래스)에 있으므로, 수정할 일이 생기면 부모클래스 하나만 고치면 자식클래스에도 반영됨
        // => 기존 클래스를 수정하지 않고도 새로운 기능을 가진 자식 클래스를 추가할 수 있다.(개방 폐쇠 원칙)
